...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <nav class="navbar navbar-light fixed-top bg-light">
            ...
            @if($student->studentaccount->one_time_auth != null)
            <div class="btn-group">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        <h5 class="card-header bg-dark text-white text-center">Password Settings</h5>
                        <div class="card-body">
                            <p class="card-title font-weight-bold custFontColor">
                                Hi {{ $student->name }}<br/>
                                @if(isset($student->studentAccount->one_time_auth))
                                Please change your password for future premises.<br/><br/>
                                ...
                                @else
                                Thanks for joining in this internship program. Please change your password for future premises.<br/><br/>
                                Note: Your password must be more than 6 characters long, should contain at-least 1 Uppercase, 1 Lowercase, 1 Numeric and 1 special character.
                                @endif
                            </p>
                            <hr class="my-4">
                            ...
                            <form action="{{ route('setpassword') }}" method="post">
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <div class="input-group">
                                        Show Password:
                                        <input type="checkbox" class="checkmark" onclick="changePasswordStudent()"/>
                                    </div>
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-danger btn-lg">Submit</button>
                                        @if($student->studentaccount->one_time_auth != null)
                                        <a href="{{ url('student/dashboard') }}" class="btn btn-success btn-lg" role="button">Go Back</a>
                                        @endif
                                    </div>
                                </fieldset>
                            </form>
