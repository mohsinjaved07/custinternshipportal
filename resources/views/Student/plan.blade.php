            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="card shadow">
                        <h5 class="card-header bg-dark text-white text-center">Internship Plan</h5>
                        <div class="card-body">
                            <p class="card-title font-weight-bold custFontColor">
                                Here are the deadlines for internship program.
                            </p>
                            <hr class="my-4">
                            ...
                            <div class="text-center">
                                <a href="{{ url('/student/dashboard') }}" class="btn btn-danger btn-lg" role="button" aria-pressed="true">Go Back</a>
                            </div>
                        </div>
                    </div>
                </div>
