                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('coordinatorsendforgotpasswordemail') }}" method="post">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" name="email" placeholder="<yourname>@cust.edu.pk"/>
                                    </div>
                                    @error('email')
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-danger btn-lg">Send Email</button>
                                </div>
                            </form>
                        </div>
                    </div>
