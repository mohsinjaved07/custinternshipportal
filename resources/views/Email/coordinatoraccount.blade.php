            ...
            <div class="row" style="margin-top:150px;">
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <h3 class="card-title font-weight-bold text-center custFontColor">Announcement</h3>
                            <hr class="my-4">
                            <br/>
                            <p>
                                <p>Congratulations, you have been appointed as an internship coordinator. Here are your credentials</p><br/><br/>
                                <strong>Name: </strong>{{ $coordinator->name }}<br/>
                                <strong>Department: </strong>{{ $coordinator->department }}<br/>
                                <strong>Office: </strong>{{ $coordinator->office }}<br/>
                                <strong>Contact No: </strong>{{ $coordinator->contactno }}<br/><br/>
                                <strong>Email: </strong>{{ $coordinator->email }}<br/>
                                <strong>Password: </strong>{{ $password }}<br/>
                                <br/><br/>
                                Please login to your account using this credentials using CUST internship portal.
                                <br/>
                                Thank you,
                            </p>
                            <br/><br/>
