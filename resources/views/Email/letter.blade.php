            ...
            <div class="row" style="margin-top:150px;">
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <h3 class="card-title font-weight-bold text-center custFontColor">Recommendation Letter</h3>
                            <hr class="my-4">
                            <p>
                            ...
                            <br/><br/>
                            <p>
                                Hi {{ $student->name }}, Thank you for registering in this internship program
                                and we all hope that you will have an entire journey in working of your desired software house.

                                Please download the attached file given below. 
                            </p>
                            <br/><br/>
                            <p>
