                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <br/>
                            <p>
                                Hi {{ $coordinator->name }}, you're account has been created in internship portal.<br/>
                                Here is your details,<br/><br/>

                                Name: <strong>{{ $coordinator->name }}</strong><br/>
                                Email: <strong>{{ $coordinator->email }}</strong><br/>
                                Password: <strong>{{ $coordinator->password }}</strong><br/>
                                Department: <strong>{{ $coordinator->department }}</strong><br/>
                                Office: <strong>{{ $coordinator->office }}</strong><br/>
                                
                                <br/><br/>
                                Please follow these credentials given above.
                                <br/><br/>
                                Thank you,
                            </p>
                            <br/><br/>
