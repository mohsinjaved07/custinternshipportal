            ...
            <div class="row" style="margin-top:150px;">
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <h3 class="card-title font-weight-bold text-center custFontColor">Confirmation</h3>
                            <hr class="my-4">
                            <br/>
                            <p>
                                Hi,<br/>

                                It is to inform you that you offered our student <strong>{{ $student->students->name }}</strong> to 
                                work at your organization. Please kindly click the link below to track our student internship progress as we 
                                need to evaluate the student's internship performance.

                                <br/><br/>

                                <a href="http://localhost:8000/confirmation/{{ $link }}">Click Here!</a>
                            </p>
                            <br/><br/>
                            <p>
