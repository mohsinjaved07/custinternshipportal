...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <nav class="navbar navbar-light fixed-top bg-light">
            ...
            <div class="btn-group">
                <button class="btn btn-info">Working Term: {{ $term->term_name }}</button>&nbsp
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        <h5 class="card-header bg-dark text-white text-center">Add Student</h5>
                        <div class="card-body">
                            <p class="card-title font-weight-bold custFontColor">
                                Please fill the following credentials.<br/>
                                Note: The student will be added under {{ session('term') }} term.
                            </p>
                            <hr class="my-4">
                            @if (session('message'))
                            ...
                            <form action="{{ route('postStudent') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" name="registration_no" value="BCS"/>    
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" name="student_CGPA"/>    
                                    </div>
                                    @error('student_CGPA')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" name="student_chrs"/>    
                                    </div>
                                    @error('student_chrs')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" name="student_contactno"/>    
                                    </div>
                                    @error('student_contactno')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" name="student_department" value="BS Computer Science"/>    
                                    </div>
                                ...
                                <div style="text-align:center">
                                    ...
                                    <a href="{{ url('/coordinator/dashboard') }}" class="btn btn-success btn-lg" role="button" aria-pressed="true">Go Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
