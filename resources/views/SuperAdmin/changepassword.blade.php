...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <h1 style="margin-top:57px;" class="text-center">Password Setting</h1>
        <hr/>
        <div class="container">
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('adminpassword') }}" method="post">
                                ...
                                <div style="text-align:center">
                                    ...
                                    <a href="{{ url('admin/dashboard') }}" class="btn btn-success btn-lg" role="button" aria-pressed="true">Go Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
