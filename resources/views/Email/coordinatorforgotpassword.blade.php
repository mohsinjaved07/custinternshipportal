            ...
            <div class="row" style="margin-top:150px;">
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <h3 class="card-title font-weight-bold text-center custFontColor">Forgot Password</h3>
                            <hr class="my-4">
                            <p>
                            ...
                            <br/><br/>
                            <p>
                                Hi <strong>{{ $coordinator->name }}</strong>,<br/>
                                
                                Please click the link below to change your password.<br/><br/>

                                <a href="http://localhost:8000/coordinator/forgotpassword/{{ $name }}">Click Here!</a>
                            </p>
                            <br/><br/>
                            <p>
