...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <h1 style="margin-top:57px;" class="text-center">Delete Coordinator</h1>
        <hr/>
        <div class="container" >
            <div class="row">
                <div class="col-md-12">
                    <div class="card shadow">
                        <h5 class="card-header bg-dark text-white text-center">Coordinator</h5>
                        <div class="card-body">
                            <p class="card-title font-weight-bold custFontColor">
                                Are you sure you want to delete {{ $coordinator->name }}?
                            </p>
                            <hr class="my-4">    
                            <form action="{{ url('admin/removecoordinator/'.$coordinator->id) }}" method="post">
                                @csrf
                                <div class="text-center">
                                    <button type="submit" class="btn btn-danger btn-lg">Yes, Delete</button>
                                    <a href="{{ url('/admin/coordinator') }}" class="btn btn-success btn-lg" role="button" aria-pressed="true">No, Go Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
