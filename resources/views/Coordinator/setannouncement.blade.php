            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        <h5 class="card-header bg-dark text-white text-center">Announcement Details</h5>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" id="Default" name="raadio" onclick="disableText()" checked/>
                                            <label for="Default">Default</label><br/>
                                            <input type="radio" id="Custom" name="raadio" onclick="enableText()"/>
