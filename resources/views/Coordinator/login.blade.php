                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <!-- <hr class="my-4"> -->
                            <form action="{{ route('validateCoordinator') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    <a href="{{ url('coordinator/forgotpasswordlink') }}">Forgot Password!</a>
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success btn-lg">Login</button>
                                    <a href="{{ url('/coordinator/registration') }}" class="btn btn-danger btn-lg" role="button" aria-pressed="true">Sign Up</a>
                                </div>
                            </form>
                        </div>
                    </div>
