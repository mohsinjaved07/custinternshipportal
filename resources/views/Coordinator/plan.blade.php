...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="container" style="margin-top:57px;">
            <h1>Set Internship Plan</h1>
            <hr/>
            <div class="row">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <div class="card shadow">
                        <h5 class="card-header bg-dark text-white text-center">Set Internship Plan</h5>
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('setplan') }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label>Date to Apply for Internship</label>
