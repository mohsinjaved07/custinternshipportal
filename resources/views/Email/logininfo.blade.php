            ...
            <div class="row" style="margin-top:150px;">
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <h3 class="card-title font-weight-bold text-center custFontColor">Login info</h3>
                            <hr class="my-4">
                            <p>
                                <strong>Registration_no: </strong>{{ $student->registration_no }}<br/>
                                <strong>Name: </strong>{{ $student->name }}<br/>
                                <strong>Email: </strong>{{ $student->email }}<br/>
                            </p>
                            <br/><br/>
                            <p>
                                Hi {{ $student->name }}, here is your login info...
                            </p>
                            <br/><br/>
                            <p>
                                Username: <strong>{{ $student->studentAccount->login_id }}</strong><br/>
                                Password: <strong>{{ $student->studentAccount->password }}</strong><br/>
                            </p><br>
                            <p>
                                Enter CUST internship portal website and log in by this credentials.
                            </p>
                            <br/><br/>                            
                            <p>
