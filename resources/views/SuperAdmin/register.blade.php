...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            .backgroundimg {
                background-image: url("{{ asset('image/custbackground.jpg') }}");
            ...
            <div class="row" style="margin-top:100px;">
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <!-- <h5 class="card-title display-4 font-weight-bold text-center custFontColor">Coordinator Registration</h5>
                            <hr class="my-4"> -->
                            <form action="{{ route('createAdmin') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" name="officeExtension"/>
                                    </div>
                                    @error('officeExtension')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success btn-lg">Register</button>
                                    <a href="{{ url('/admin/login') }}" class="btn btn-danger btn-lg" role="button" aria-pressed="true">Go Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
