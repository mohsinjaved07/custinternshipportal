                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                <strong>Registration No:</strong> {{ $student->registration_no }}<br/>
                                ...
                                You're viva is scheduled on {{ Carbon\Carbon::parse($student->studentLink->date)->toFormattedDateString() }}.<br/><br/>
                                And you're evaluator is:<br/><br/>
