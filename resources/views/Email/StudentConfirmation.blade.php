            ...
            <div class="row" style="margin-top:150px;">
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <h3 class="card-title font-weight-bold text-center custFontColor">Supervisor Confirmation</h3>
                            <hr class="my-4">
                            <p>
                            ...
                            <br/><br/>
                            <p>
                                Hi <strong>{{ $student->name }}</strong>,<br/>
                                
                                Congratulations, your supervisor of your organization has approved your request to work as an internee.<br/>
                                Now, you can upload the offer letter received from organization on CUST portal.<br/>
