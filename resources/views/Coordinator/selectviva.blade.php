                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <p class="card-title font-weight-bold custFontColor">
                                Please assign the faculty member for viva.
                            </p>
                            <hr class="my-4">
                            @if (session('message'))
                            ...
                            <form action="{{ url('/coordinator/viva/'.$student->registration_no.'/'.$student->term_name) }}" method="post">
                                ...
                                <p>
                                    Please evaluate the student [{{ $student->students->name }}] for his/her internship. Please check for;
                                    <ol>
                                        <li>The tasks accomplished as in progress report.</li>
                                        <li>The Knowledge in the domain of work.</li>
                                        <li>External evaluator's evaluations and remarks.</li>
                                    </ol>
                                    Regards,<br/>
                                    {{ $root->coordinators->name }}<br/>
                                    Internship Coordinator [{{ $root->coordinators->department }}]<br/>
                                </p>
                                <div style="text-align:center">
                                    <button type="submit" class="btn btn-danger btn-lg">Submit</button>
                                    <a href="{{ url('/coordinator/organizationlist') }}" class="btn btn-success btn-lg" role="button" aria-pressed="true">Go Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
